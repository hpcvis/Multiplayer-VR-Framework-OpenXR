...
namespace Valve.VR.InteractionSystem
{
    ...
    //We changed code to allow transfer ownership on interactable pickup/drop
    //CustomInteractable.cs can not be directly added to the scene as a significant part of the interactable.cs script relies on something that the hands explicitly do for the interactable.cs script
    public class Interactable : MonoBehaviour
    {
        //<Changed code>
        public Behaviour transferOwnership;
        //<\Changed code>
        ...
        protected virtual void OnAttachedToHand(Hand hand)
        {
            ...
            //<Changed code>
            transferOwnership.SendMessage("transferOwnership");
            //<\Changed code>
